...
public class NearbyDriver {
	...
	/*
	 * args[0]: Cleaning test directory path args[1]: Output bucket(directory)
	 * path
	 */
	public static void main(String[] args) throws Exception {
		Configuration conf = new Configuration();
		String[] paths = new GenericOptionsParser(conf, args)
				.getRemainingArgs();
		...
		try {
			BufferedReader br = new BufferedReader(new FileReader("nearby.csv"));
